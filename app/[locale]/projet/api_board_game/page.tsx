    ...
    <div className='min-h-screen'>
      ...
      <main className='container mx-auto px-4 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
          <div className='p-6 border-2 border-white/10 rounded-3xl'>
            ...
            <ul className='list-disc pl-6 space-y-2 text-white'>
              ...
              <li>
                Créer une interface utilisateur intuitive pour interagir avec
                l&apos;API
              </li>
              <li>
                Implémenter les opérations CRUD pour la gestion des jeux de
                plateau
              </li>
              <li>
                Mettre en place une documentation claire pour l&apos;utilisation
                de l&apos;API
              </li>
              <li>
          ...
          <div className='p-6 border-2 border-white/10 rounded-3xl'>
            ...
            <ul className='list-disc pl-6 space-y-2 text-white'>
              <li>
                <span className='font-medium'>Backend :</span> PHP
              </li>
              <li>
              ...
              <li>
                <span className='font-medium'>Outils :</span> Postman (tests
                API)
              </li>
              <li>
                <span className='font-medium'>Méthodologie :</span> Conception
                RESTful
              </li>
            </ul>
          </div>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-white'>
            <li>
              <span className='font-medium'>Modèle :</span> Gestion des accès à
              la base de données et logique métier
            </li>
            <li>
              <span className='font-medium'>Vue :</span> Interface utilisateur
              pour interagir avec l&apos;API
            </li>
            <li>
              <span className='font-medium'>Contrôleur :</span> Endpoints de
              l&apos;API qui traitent les requêtes et renvoient les réponses
            </li>
            <li>
              <span className='font-medium'>Routes :</span> Définition des
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-white'>
            <li>
              Conception d&apos;une structure de base de données optimisée pour
              les jeux de plateau
            </li>
            <li>
              Implémentation d&apos;un système de sécurité robuste pour
              l&apos;API
            </li>
            <li>
              Gestion des erreurs et retours adaptés aux standards RESTful
            </li>
            <li>
              Création d&apos;une documentation claire et facile à utiliser
            </li>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-white'>
            <li>
              Ajout de fonctionnalités sociales (avis, notations, commentaires)
            </li>
            <li>
              Extension de l&apos;API pour inclure des règles de jeux et des
              tutoriels
            </li>
            <li>
              Développement d&apos;une application mobile connectée à l&apos;API
            </li>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <div className='flex flex-col space-y-3'>
            <Link
              href='https://github.com/Ayo5/SIte_API_Boardgame'
              target='_blank'
