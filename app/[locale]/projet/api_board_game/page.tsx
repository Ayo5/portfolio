  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="border-2 border-gray-300 dark:border-gray-600 rounded-3xl p-6 mb-8 bg-white dark:bg-gray-800 shadow-md">
          ...
          <div className="flex justify-center my-6">
            <div className="relative w-full max-w-2xl h-64 md:h-96">
              <Image
                src="/projet/site_api_board_game.png"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="p-6 border-2 border-gray-300 dark:border-gray-600 rounded-3xl bg-white dark:bg-gray-800 shadow-md">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">
              Objectifs du projet
            </h2>
        ...
        <div className="border-2 border-gray-300 dark:border-gray-600 rounded-3xl p-6 mb-8 bg-white dark:bg-gray-800 shadow-md">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li><span className="font-medium text-gray-900 dark:text-white">Contrôleur :</span> Endpoints de l&apos;API qui traitent les requêtes et renvoient les réponses</li>
            <li><span className="font-medium text-gray-900 dark:text-white">Routes :</span> Définition des chemins d&apos;accès à l&apos;API</li>
          </ul>
        </div>
