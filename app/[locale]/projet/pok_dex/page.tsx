      ...
      <main className='container mx-auto px-4 py-8'>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <p className='text-white mb-4'>
            ...
            Informatique. Le Pok-dex est un site web créé avec Python-Flask qui
            utilise l&apos;API PokeAPI pour afficher des informations détaillées
            sur les différents Pokémon. Ce projet m&apos;a permis
            d&apos;explorer l&apos;intégration d&apos;API externes et le
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
          <div className='p-6 border-2 border-white/10 rounded-3xl'>
            ...
            <ul className='list-disc pl-6 space-y-2 text-white'>
              ...
              <li>
                Intégrer l&apos;API PokeAPI pour récupérer les données Pokémon
              </li>
              ...
              <li>
                Améliorer mes compétences en Python et en développement web
              </li>
            </ul>
          </div>
          ...
          <div className='p-6 border-2 border-white/10 rounded-3xl'>
            ...
            <ul className='list-disc pl-6 space-y-2 text-white'>
              <li>
                <span className='font-medium'>Backend :</span> Python, Flask
              </li>
              <li>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <ul className='list-disc pl-6 space-y-2 text-white'>
              <li>
                Affichage de la liste complète des Pokémon avec pagination
              </li>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <p className='text-white mb-4'>
            ...
            (Modèle-Vue-Contrôleur) adaptée à Flask :
          </p>
          <ul className='list-disc pl-6 space-y-2 text-white'>
            <li>
              <span className='font-medium'>Modèle :</span> Services
              d&apos;accès à l&apos;API et traitement des données
            </li>
            <li>
              <span className='font-medium'>Contrôleur :</span> Routes Flask
              gérant les requêtes et préparant les données
            </li>
            <li>
              <span className='font-medium'>Static :</span> Fichiers CSS,
              JavaScript et images
            </li>
            <li>
              <span className='font-medium'>Helpers :</span> Fonctions
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-white'>
            <li>
              Gestion efficace des requêtes API pour éviter le rate limiting
            </li>
            <li>
              Mise en place d&apos;un système de cache pour améliorer les
              performances
            </li>
            <li>
              Développement d&apos;une interface intuitive pour naviguer parmi
              plus de 800 Pokémon
            </li>
            <li>Création d&apos;une architecture évolutive et maintenable</li>
            <li>
              Optimisation des temps de chargement pour une expérience
              utilisateur fluide
            </li>
          </ul>
        </div>
        ...
        <div className='border-2 border-white/10 rounded-3xl p-6 mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-white'>
            <li>
              Ajout d&apos;un système de compte utilisateur pour sauvegarder des
              favoris
            </li>
            <li>
              Création d&apos;un comparateur de Pokémon et de leurs statistiques
            </li>
            <li>
              Développement de fonctionnalités sociales (équipes partagées,
              commentaires)
            </li>
            <li>
              Implémentation d&apos;un mode hors ligne avec stockage local
            </li>
