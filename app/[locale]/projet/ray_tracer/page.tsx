      ...
      <main className='container mx-auto px-4 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
          ...
          <div className='p-6 border-2 border-white/10 rounded-3xl'>
            ...
            <ul className='list-disc pl-6 space-y-2 text-white'>
              <li>
                <span className='font-medium'>Langage :</span> Java
              </li>
              <li>
              ...
              <li>
                <span className='font-medium'>Bibliothèques :</span> Java (From
                Scratch)
              </li>
              <li>
                <span className='font-medium'>Méthodes mathématiques :</span>{" "}
                Algèbre linéaire, calcul vectoriel, algorithmes
                d&apos;intersection
              </li>
            </ul>
          </div>
